...
3. [Data Frames:Manejo de ficheros o conjuntos de datos.](/index.html#56)

4. [Creación de funciones.](/index.html#71)

5. [Instalación y trabajo con paquetes.](/index.html#92)
...
.footnote[[4] [Cheetsheet](https://github.com/rstudio/cheatsheets/raw/master/data-transformation.pdf)]
---
...
---
* Crear el *dataframe* `filtrado` que contenga una nueva columna llamada `T1_100` que sea igual a la columna `1T_2018` de la tabla `gasto` dividida por 1000, seleccionar aquellos países cuyo valor en esta nueva columna sea mayor o igial a 2 y ordenarlos por el valor obtenido en esta columna.
```{r}
filtrado <- datos %>%
...
.footnote[[5][Cheetsheet](https://github.com/rstudio/cheatsheets/blob/master/data-import.pdf)]
